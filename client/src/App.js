...
if(list===null){
  ...
  axios.get("https://password-manager-server-cyan.vercel.app/getList").then((result)=>{
...
axios.post("https://password-manager-server-cyan.vercel.app/get",{name : e.name}).then((result)=>{
